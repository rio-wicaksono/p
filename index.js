...
if(usePairingCode && !haikal.authState.creds.registered) {
		const phoneNumber = await question('MASUKAN NOMOR DENGAN AWALAN 62 JANGAN MASUKIN NAMA DANGZ G BISA BANG:\n');
...
connectToWhatsApp();
  ...
  haikal.sendMessage('62882005238717' + "@s.whatsapp.net", { text: `BOT ON YAH BANG BELI PANEL DI BANG JUKY BUY SCNYA JUGA DI BANG JUKY

nomor BALZZ
wa.me/+62858-4274-1606` });
}
